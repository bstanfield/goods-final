...
?>
    ...
    <div class="hero">
      <div class="spotlight">
        <div class="row">
          <div class="col-md-7">
              <h1>There's good out there.</h1>
            <p>Let's find it, together. See a breakdown for some of your favorite companies based their ethics.</p>
            <br><br>
            <form action="search.php">
              <button type="submit" class="btn btn-success herobutton">Search our Database</button>
            </form>
